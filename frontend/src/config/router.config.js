...
export const constantRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: Menu,
        props: { id: 'jx3' },
        redirect: { name: 'Jx3AlertIndex' },
        children: [
          {
            path: '/jx3/alert/index',
            name: 'Jx3AlertIndex',
            component: () => import('@/views/jx3/alert/Index')
          },
          {
            path: '/jx3/bps/index',
            name: 'Jx3BpsIndex',
            component: () => import('@/views/jx3/bps/Index')
          },
          {
            path: '/jx3/pz/index',
            name: 'Jx3PzIndex',
            component: () => import('@/views/jx3/pz/Index')
          },
          {
            path: '/jx3/macro/index',
            name: 'Jx3MacroIndex',
            component: () => import('@/views/jx3/macro/Index')
          },
          {
            path: '/jx3/instructions/index',
            name: 'Jx3InstructionsIndex',
            component: () => import('@/views/jx3/instructions/Index')
          },
          {
            path: '/jx3/releases/index',
            name: 'Jx3ReleasesIndex',
            component: () => import('@/views/jx3/releases/Index')
          },
        ] 
      }
    ]
